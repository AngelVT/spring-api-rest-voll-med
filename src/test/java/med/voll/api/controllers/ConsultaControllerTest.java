...
import med.voll.api.domain.consulta.DatosListadoConsulta;
...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DatosConsulta> agendarConsultaJacksonTester;

    @Autowired
    private JacksonTester<DatosRespuestaConsulta> detalleConsultaJacksonTester;

    @MockBean
    private ConsultaAgendaService agendaDeConsultaService;
    ...
    void agendarEscenario2() throws Exception {
        ...
        var datos = new DatosRespuestaConsulta(null,2l,5l,fecha,true,null);
        ...
        var response = mvc.perform(post("/consultas")
                ...
                .content(agendarConsultaJacksonTester.write(new DatosConsulta(2l,5l,fecha, especialidad)).getJson())
